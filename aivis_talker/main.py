# aivis_talker/main.py

# import sys
# import asyncio
from aivis_yomiage import AivisYomiage, Aivis_Speaker
...
app = FastAPI()
yomiage = AivisYomiage(speaker_id=Aivis_Speaker.四国めたん.value, speed=1)
...
async def query(text: str):
    # return AivisYomiage.AudioQuery_to_dict(yomiage.get_audio_query(text))
    return json.dumps((yomiage.get_audio_query(text)))
